...
class Research:
    ...
    def file_reader(self, has_header = True):
        ...
        logging.debug('Research: Reading file')
        ...
        logging.debug('Research: Validate file')
    ...
    class Calculations:
        ...
        def counts(self, data = None):
            ...
            logging.debug('Calculations: Calculating the counts of heads and tails')
            for line in data:
        ...
        def fractions(self, count = None):
            if count is None:
                count = self.counts()
            total = sum(count) 
            logging.debug('Calculations: Calculating the fractions of heads and tails')
...
class Analytics(Research.Calculations):
    ...
    def predict_random(self, count_of_predictions):
        ...
        logging.debug('Analytics: generate random predictions')
    ...
    def save_file(self, data, filename, format):
        ...
        logging.debug(f'Analytics: save to file {path}')
        with open(path , 'w') as f:
            print(data, file=f)

    
    def predict_last(self): 
        logging.debug(f'Analytics: predict last')
